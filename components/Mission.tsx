...
const Mission = () => {
  ...
  return (
    <section
      ref={scrollRef}
      id="mission"
      className="w-full my-10 lg:px-28 min-h-[70vh]  md:px-20 px-4 flex-1 rounded-md flex flex-col  justify-center items-center"
    >
      ...
      <div className="flex items-center justify-between lg:flex-row flex-col gap-5">
        <div ref={missionRef} className="space-y-3">
          <p className="lg:w-3/4 text-lg w-full dark:font-light">
          ...
          <p className="lg:w-3/4 text-lg font-semibold italic w-full">
          ...
          <p className="lg:w-3/4 text-lg dark:font-light w-full">
        ...
        <div className="w-full  dark:bg-white rounded-lg border flex items-center justify-center">
          <Image
            ...
            height={500}
            alt="Prayse Logo"
            className="aspect-square w-full hidden lg:flex sm:flex md:flex"
          />
        </div>
      </div>
    </section>
